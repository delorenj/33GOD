...
| [Agent Orchestration](#agent-orchestration)        | Flume, Yi, AgentForge                       | Agents, teams, roles, protocols         |
| [Workspace Management](#workspace-management)      | iMi, Zellij-Driver, Perth                   | Git, worktrees, sessions, terminals     |
| [Meeting & Collaboration](#meeting--collaboration) | TheBoard, TheBoard Room                     | Brainstorming, meetings, convergence    |
| [Dashboards & Voice](#dashboards--voice)           | Holocene, HeyMa                             | Dashboards, voice, UI, visualization    |
