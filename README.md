...
| **[Momo](momo/)**             | Policy/process-manager and durable work actor that ranks only Lifecycle-legal work, executes exact canonical skill invocations, and publishes artifact-backed evidence through Bloodbank.            |
