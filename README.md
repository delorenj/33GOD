...
| **[Holocene](holocene/)**     | Mission-control renderer backed by Candystore projections, with real browser controls that publish high-level Lifecycle commands through Bloodbank. It never derives or persists lifecycle truth. |
