...
| **[Momo](momo/)**             | Policy/process-manager client that ranks only Lifecycle-legal work, resolves canonical skills, and submits invocation/evidence/command intent through Bloodbank.                                     |
