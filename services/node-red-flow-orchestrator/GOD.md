...
|------------|--------|---------|
| `fireflies.transcript.upload` | `fireflies/transcript/upload.v1.json` | Media file uploaded to MinIO and submitted to Fireflies |
...
|------------|--------|-------|--------|
| `fireflies.transcript.upload` | `fireflies/transcript/upload.v1.json` | `node-red.fireflies.upload` | Calls Fireflies uploadAudio API |
| `fireflies.transcript.ready` | `fireflies/transcript/ready.v1.json` | `node-red.fireflies.ready` | Writes CSV + Markdown transcript files |
...
| split-silence | node-red-contrib-split-silence | Silence detection + audio chunking via ffmpeg |
